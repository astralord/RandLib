...
template < typename T >
std::__cxx11::string ProbabilityDistribution<T>::toStringWithPrecision(const double a_value, const int n) const
{
...
template < typename T >
std::__cxx11::string ProbabilityDistribution<T>::fitErrorDescription(ProbabilityDistribution::FIT_ERROR_TYPE fet, const std::__cxx11::string &explanation)
{
    std::__cxx11::string error = this->Name() + ": ";
    switch (fet) {
    case WRONG_SAMPLE:
